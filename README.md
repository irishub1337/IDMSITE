	...
	<div class="app">
		<div class="header">
			...
			<div class="header-menu">
				<a class="menu-link is-active" href="#">Приложения</a>
				<a class="menu-link notify" href="#">Мои Работы</a>
				<a class="menu-link" href="#">Интересное</a>
				<a class="menu-link notify" href="#">Маркет</a>
			</div>
				...
				<div class="wrapper">
					<div class="left-side">
						<div class="side-wrapper">
							<div class="side-title">Начало</div>
							<div class="side-menu">
								<a href="#">
